...
# Cover Image
image_path = input("Enter the cover image filename (with extension): ")
im = Image.open(image_path)
im.save("temp_images/temp_flip.jpg", optimize=True, quality=60)
im.save("temp_images/temp_flip.png", optimize=True)
